...
const ButtonGroup = () => {
    ...
    const[presence, setSelectedPresence] = useState(null);
            ...
            {activeMenu === 'h2s' && (
                <div className='text-center mt-5'>
                    ...
                    <button
                        ...
                        id="yellow"
                        name="test_color"
                        value="YELLOW" onClick={() => handleButtonClick('Yellow')}
                    ...
                    <button
                        ...
                        id="black"
                        name="test_color"
                        value="BLACK" onClick={() => handleButtonClick('Black')}
          ...
          METHODS
                    ...
                    {isYellowTextVisible &&  (
                        <div>
                            ...
                            <p>WATER IS CONSUMABLE, NO FAECAL CONTAMINATION </p>
                    ...
                    <button  className='btn btn-success mt-5' type="submit" value="Submit"  onClick={handleDoneButtonClick} >
                        DONE
                    </button>
                </div>
            )}
