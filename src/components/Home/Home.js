...
function Home() {
  ...
  const [completedProcessH2S, setcompletedProcessH2S] = useState('Completed 0/1'); // Initialize as "0/1"
  ...
  const handleOptionChange = (event) => {
    ...
    if (selectedValue !== 'Select') {
      setcompletedProcessWaterSource('Completed 1/1');
    } else {
      setcompletedProcessWaterSource('Completed 0/1'); // Reset to "0/1" when 'Select' is chosen
    }
  };

  const handleH2SChange = (event) => {
  ...
  async function submitForm(){
    var data ={
        samplingData:completedProcessSamplingData,
        waterSource:completedProcessWaterSource,
        waterAccessibility:selectedOption,
        h2test:completedProcessH2S,
        userId:1,
        pitLatrine:question1Answer,
        domesticAnimal:question2Answer,
        diaperDisposal:question3Answer,
        wasteWaterRelease:question4Answer,
        openDefaction:question5Answer,
        unprotectedWaterSource:question6Answer,
        agriculturalActivity:question7Answer,
        observerLaundryActivity:question8Answer,
        samplingId:1
    }
    const loginData =  await axios.post('http://localhost:3005/api/login',data)
  ...
  return (
    ...
    <div className="survey">
      ...
      <div className="menu-item" style={divStyle} onClick={() => handleMenuClick('water')}>
        Water Source {completedProcessWaterSource && <span style={{ marginLeft: '100px' }}>{completedProcessWaterSource}</span>}
      </div>
     <div> {activeMenu === 'water' && (
        <div className="submenu1">
            ...
            <li> <input type="radio" id="river" name="test" value="River"></input>
...
<div className='th'> <tr>Water Accessibility: </tr></div>
            ...
            <li> <input type="radio" id="river" name="test" value="River"></input>
          <label for="river">Easy</label></li>
        <li> <input type="radio" id="river" name="test" value="River"></input>
          <label for="river">Hard</label></li>
...
<br></br>
      <div className="menu-item" style={divStyle} onClick={() => handleMenuClick('sampling')}>
        Sampling Data {completedProcessSamplingData && <span style={{ marginLeft: '90px' }}>{completedProcessSamplingData}</span>}
      </div>
      {activeMenu === 'sampling' && (
...
<div className="menu-item" style={divStyle} onClick={() => handleMenuClick('h2s')}>
      ...
      {activeMenu === 'h2s' && (
        <div className="submenu" >
              ...
              <button className='yellow' id="yellow" name="test_color" value="YELLOW" onClick={handleButtonClick} >
          ...
          {isTextVisible && <p>Absence of faecal contamination</p>}
             
          <button className='black' id="black" name="test_color" value="BLACK" onClick={handleButtonClick}>   
            <input
              type="radio"
              value="Black"
              name="h2sColor"
      ...
      <br></br>
        ...
        <button type="submit" value="Submit" style={divStyleSubmit} onClick={submitForm}>SUBMIT</button>
    </div>
  );
}
